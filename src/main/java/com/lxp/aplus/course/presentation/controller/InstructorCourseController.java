...
public class InstructorCourseController {
    ...
    public ResponseEntity<ResultResponse<CourseUpsertResponse>> createCourse(
        ...
        CourseUpsertResult result = courseCommandUseCase.createCourse(request.toCommand(instructorId));
    ...
    public ResponseEntity<ResultResponse<CourseUpsertResponse>> updateCourse(
        ...
        CourseUpsertResult result = courseCommandUseCase.updateCourse(request.toCommand(courseId, instructorId));
